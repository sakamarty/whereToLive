...
if user_law == str("abortion") and user_state == str("Alaska"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(abortionLaw).get(3)) + ".")
        exit()
    if user_law == str("cannabis") and user_state == str("Alaska"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(cannabisLaw).get(2)) + "." )
        exit()

    if user_law == str("abortion") and user_state == str("Arkansas"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(abortionLaw).get(0)) + ".")
        exit()
    if user_law == str("cannabis") and user_state == str("Arkansas"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(cannabisLaw).get(1)) + "." )
        exit()

    if user_law == str("abortion") and user_state == str(""):
        print("In " + user_state + ", " + user_law + " is " + str(dict(abortionLaw).get()) + ".")
        exit()
    if user_law == str("cannabis") and user_state == str(""):
        print("In " + user_state + ", " + user_law + " is " + str(dict(cannabisLaw).get()) + "." )
        exit()
    ...
    if user_law == str("abortion") and user_state == str("Florida"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(abortionLaw).get(1)) + ".")
        exit()
    if user_law == str("cannabis") and user_state == str("Florida"):
        print("In " + user_state + ", " + user_law + " is " + str(dict(cannabisLaw).get(1)) + "." )
        exit()